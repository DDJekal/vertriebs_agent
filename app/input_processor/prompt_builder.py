...
TALENT_REPORT_POSTAMBLE = (
    ...
    "\n"
    "**LOGO – PFLICHT:**\n"
    "- Das Skript lädt das Logo automatisch aus dem Skill-Ordner (`templates/logo.png`).\n"
    "- Nutze beim Skript-Aufruf zwingend `--project-dir .`, damit ein eventuelles "
    "Projektlogo (`logo.png` / `logo.svg` im Projektordner) korrekt geladen wird.\n"
    "- Footer zeigt 'Talent Report 2026' + Logo auf dunkelgrünem (#1a2e0d) Hintergrund.\n"
